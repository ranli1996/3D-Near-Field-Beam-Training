function [new_snr,count,nmse]=method_mirror_2_phase_bit(num_x,num_z,M,lambda,antenna_coor,aperture_x,aperture_z,noise_power,channel,y_list,y_list_index,bit)
...
for m=1:M
    for x=1:2
        for z=1:2
            ...
            mirror_words(point_index,:)=quantize_phase(mirror_words(point_index,:),bit)/sqrt(num_all);
