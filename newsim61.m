...
new_snr_list=zeros(length(snr_list),2*4);
count_list=zeros(length(snr_list),2*4);
nmse_list=zeros(length(snr_list),2*4);
parfor index=1:length(snr_list)
    snr_list_tem=zeros(1,2*4);
    count_list_tem=zeros(1,2*4);
    nmse_list_tem=zeros(1,2*4);
    snr=snr_list(index);
    ...
    for i=1:test_point_num
        ...
        [new_snr,count,nmse]=method_mirror_2_phase_hard(num_x,num_z,M,lambda,antenna_coor,aperture_x,aperture_z,noise_power,channel,y_list,y_list_index,0);
        snr_list_tem(1)=snr_list_tem(1)+new_snr;
        count_list_tem(1)=count_list_tem(1)+count;
        nmse_list_tem(1)=nmse_list_tem(1)+nmse;

        [new_snr,count,nmse]=method_mirror_2_phase_hard(num_x,num_z,M,lambda,antenna_coor,aperture_x,aperture_z,noise_power,channel,y_list,y_list_index,0.25);
        snr_list_tem(2)=snr_list_tem(2)+new_snr;
        count_list_tem(2)=count_list_tem(2)+count;
        nmse_list_tem(2)=nmse_list_tem(2)+nmse;

        [new_snr,count,nmse]=method_mirror_2_phase_hard(num_x,num_z,M,lambda,antenna_coor,aperture_x,aperture_z,noise_power,channel,y_list,y_list_index,0.50);
        snr_list_tem(3)=snr_list_tem(3)+new_snr;
        count_list_tem(3)=count_list_tem(3)+count;
        nmse_list_tem(3)=nmse_list_tem(3)+nmse;

        [new_snr,count,nmse]=method_mirror_2_phase_hard(num_x,num_z,M,lambda,antenna_coor,aperture_x,aperture_z,noise_power,channel,y_list,y_list_index,0.75);
        snr_list_tem(4)=snr_list_tem(4)+new_snr;
        count_list_tem(4)=count_list_tem(4)+count;
        nmse_list_tem(4)=nmse_list_tem(4)+nmse;
        
        [new_snr,count,nmse]=method_mirror_3_phase_hard(num_x,num_z,M,lambda,antenna_coor,aperture_x,aperture_z,noise_power,channel,y_list,y_list_index,0);
        snr_list_tem(5)=snr_list_tem(5)+new_snr;
        count_list_tem(5)=count_list_tem(5)+count;
        nmse_list_tem(5)=nmse_list_tem(5)+nmse;

        [new_snr,count,nmse]=method_mirror_3_phase_hard(num_x,num_z,M,lambda,antenna_coor,aperture_x,aperture_z,noise_power,channel,y_list,y_list_index,0.25);
        snr_list_tem(6)=snr_list_tem(6)+new_snr;
        count_list_tem(6)=count_list_tem(6)+count;
        nmse_list_tem(6)=nmse_list_tem(6)+nmse;

        [new_snr,count,nmse]=method_mirror_3_phase_hard(num_x,num_z,M,lambda,antenna_coor,aperture_x,aperture_z,noise_power,channel,y_list,y_list_index,0.50);
        snr_list_tem(7)=snr_list_tem(7)+new_snr;
        count_list_tem(7)=count_list_tem(7)+count;
        nmse_list_tem(7)=nmse_list_tem(7)+nmse;

        [new_snr,count,nmse]=method_mirror_3_phase_hard(num_x,num_z,M,lambda,antenna_coor,aperture_x,aperture_z,noise_power,channel,y_list,y_list_index,0.75);
...
save('data61.mat','snr_list','new_snr_list','num_x','num_z');
toc;
